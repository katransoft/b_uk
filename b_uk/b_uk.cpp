...
// b_uk.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Cb_ukApp, CWinApp)
...
// Единственный объект Cb_ukApp

Cb_ukApp theApp;


// инициализация Cb_ukApp

BOOL Cb_ukApp::InitInstance()
{
